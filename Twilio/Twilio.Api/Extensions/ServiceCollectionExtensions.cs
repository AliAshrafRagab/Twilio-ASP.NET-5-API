...
using System.Text;
using Twilio.Api.Services;
using Twilio.Application.DTOs.Settings;
...
using Twilio.Infrastructure.Identity.Services;
using Twilio.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\Twilio.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
